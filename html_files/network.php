...
<html lang="en-US">
    ...
    <div id="wrapper">
        ...
        <br><br><br><br><br>
        <p class="direct"><a id="dir" href="index.php">Home &nbsp</a><span style="color:gray;"> >&nbsp Networking Appliances</span></p>
        <hr>
        ...
        if(isset($_SESSION["lvl"])) {
            $folder= "network"; require_once('../PHP_files/upload.php');
        }
        ?>
        </div>
